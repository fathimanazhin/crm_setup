    ...
    <form method="POST" action="{{ route('tasks.store') }}"
        ...
        <div>
            ...
            <textarea name="description" rows="3"
                      class="w-full bg-indigo-950 border border-indigo-700 px-3 py-2 rounded text-white focus:outline-none focus:ring-2 focus:ring-cyan-400">{{ old('description') }}</textarea>
        </div>
